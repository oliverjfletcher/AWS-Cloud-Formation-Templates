...
The desired goal is to automate deployment end to end using AWS Cloudformation so that an engineer to simply input minimal configuration and stand up an entire enviroment.
